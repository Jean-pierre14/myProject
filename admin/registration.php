                                        ...
                                        <div class="container-fluid p-0 m-0">
                                            <div class="row mt-4">
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <img src="../assets/images/erc/pastor.jpg" alt="Pastor" class="img-fluid">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <img src="../assets/images/erc/marcelo.jfif" alt="Pastor" class="img-fluid">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <marquee behavior="" direction=""><small class="text-danger">Ephesians</small></marquee>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-md-5">
                                                    <form action="" method="post">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="search" name="search" id="search_txt2" class="form-control" placeholder="Typing...">
                                                        </div>
                                                    </form>
                                                    <div id="selectPastor">
                                                        <!-- Ajax -->
                                                ...
                                                <form action="" method="post">
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-7 p-0">
                                                            <div class="input-group mb-3">                                                                
                                                                <input type="text" class="form-control" name="theme" id="theme" placeholder="Date">
                        ...
                        <div class="row pt-2 bg-white">
                            <div class="col-md-3">
                                <form action="" autocomplete="off" method="post">
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" id="search_txt" name="search" placeholder="Your Email">
                                        <div class="input-group-append">
                                        <span class="input-group-text">Search</span>
                                        </div>
                                    </div>
                                            ...
                                            <?php if(isset($_GET['member'])): ?>
                                                ...
                                                <div class="container-fluid m-0 p-0">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="card">
                                                                <img class="img-fluid ui image" src="<?php print $memberArray[4];?>" alt="Profile <?php print $memberArray[0];?>" style="width: 100%;">
                                                                <div class="card-body">
                                                                ...
                                                                <div class="card-footer p-1 text-center">
                                                                    <div class="btn-group">
                                                                        <a href="#" class="btn btn-sm btn-fill btn-info" rel="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                                                                        <a href="#" class="btn btn-sm btn-fill btn-danger" rel="tooltip" title="Delete"><i class="fa fa-trash"></i></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">                                
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    ...
                                                                    <p class="d-flex justify-content-between align-items-center">
                                                                        <small>Email : </small>
                                                                        <small class="text-success"><?php print $memberArray[2];?></small>
                                                                    </p>
                                                                </div>
                                                                <div class="card-footer p-1">
                                                                    <a href="registration.php" class="btn btn-sm btn-danger btn-fill"><i class="fa fa-arrow-circle-left"></i> Back</a>
                                                                </div>
                                                            </div>                                           
                                                        </div>                            
                                                    </div>
                                                    ...
                                                    <?php elseif($memberArray[9] == 'fiance'):?>
                                                        <div class="container-fluid m-0 p-0">
                                                            <p class="ui message positive d-flex justify-content-between">
                                                                ...
                                                                <span><img src="../assets/images/loading.gif" alt="Loading..." class="ui mini avatar" style="width: 20px;height: 20px"></span>
                                                            </p>
                                                        </div>
                                                                                            ...
                                                                                            <form action="" method="post">
                                                                                                <div class="form-row">
                                                                                                    <div class="form-group col-md-6">
                                                                                                        <select name="patner" id="patener" class="custom-select">
                                                                                                            <?php  if($memberArray[8] == 'Male'): ?>
                                                                                                                <option value=""> -- Choose a wife --</option>
                                                                                                                <?php
                                                                                                                    $selectPatner = mysqli_query($con, "SELECT * FROM user_account WHERE gender LIKE 'female' AND statu = 'fiance'");
                                                                                                                ?>
                                                                                                            <?php else: ?>
                                                                                                                <option value=""> -- Choose a Husband --</option>
                                                                                                                <?php
                                                                                                            ...
                                                                                                            <?php if( @mysqli_num_rows($selectPatner) > 0 ):?>
                                                                                                                <?php while($rowPatner = mysqli_fetch_array($selectPatner)):?>
                                                                                                                    <option value="<?php print $rowPatner['id'];?>"><?php print $rowPatner['name'];?></option>
                                                                                                                <?php  endwhile;?>
                                                                                                            <?php else: ?>
                                                                                                                <option value="" class="text-danger">There no Data</option>
                                                                                                            <?php endif; ?>                                                                                                                                                        
                                                                                                        </select>
                                                                                                    </div>
                                                                                                    <div class="form-group col-md-6">
                                                                                                    ...
                                                                                                    <div class="form-group col-md-12">
                                                                                                        <div class="input-group mb-3">
                                                                                                            <input type="date" class="form-control" placeholder="Your Email">
                                                                                                            <div class="input-group-append">
                                                                                                                <span class="input-group-text">Date of the wedding</span>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="form-group">
                                                                                                    <button type="submit" class="btn btn-fill btn-success btn-md">Record now <i class="fa fa-arrow-circle-right"></i></button>
                                                                                                </div>
                                                                                            </form>
                                                                                        <?php endif;?>
                                                                                    </div>
                                                ...
                                                <form action="" method="post">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" value="<?php print $username;?>" name="username" id="username" placeholder="Username">
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <div class="input-group mb-3 input-group-md">
                                                            <input type="text" name="name" id="name" value="<?php print $name;?>" class="form-control" placeholder="Name">
                                                            <div class="input-group-append">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input type="email" name="email" id="email" value="<?php print $email;?>" class="form-control" placeholder="Email@gmail.com">
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-md-7">
                                                            ...
                                                            <input type="text" value="<?php print $location;?>" name="location" placeholder="Location" id="location" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-md-5">
                                                            <select name="depart" id="department" class="custom-select text-center">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="date" name="dob" id="dob" value="<?php print $dob;?>" placeholder="Date of birth" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <div class="input-group mb-3 input-group-md">
                                                            <input type="tel" name="phone" id="phone" value="<?php print $phones;?>" placeholder="phone numbers" class="form-control">
                                                            <div class="input-group-append">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            <textarea name="about" disabled value="Status" rows="3" placeholder="About user" class="form-control"></textarea>
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <button class="btn btn-md btn-success" name="new-user" type="submit">Register <i class="fa fa-arrow-circle-right"></i></button>
                                                        </div>
                                                    </div>
                                                </form>
                                            <?php endif; ?>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form action="" method="post">
                  ...
                  <div class="form-group">
                      <button type="button" class="btn btn-fill btn-sm btn-success RecordPastor">Record <i class="fa fa-arrow-circle-right"></i></button>
                  </div>
              </form>
            </div>
    ...
    $().ready( ()=>{
        ...
        $(document).on("click", ".RecordPastor", function(){
            ...
            $.ajax({
                url: '../event/event.php',
                method: 'post',
                data: {action: action, pastorId: pastorId,pastorName: pastorName},
                success: function(data){
                    if(data = 'success'){
                        $('#successMsg').html('<p class="ui message positive">Registration success!</p>');
                    }else{
                        $('#successMsg').html('<p class="ui message negative">Failed! Check these not an empty field</p>');
                    }
                }
            })
        });
